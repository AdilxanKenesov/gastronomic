...
class _HomeScreenState extends State<HomeScreen> with RestaurantNavigationMixin {
  ...
  Widget _buildHorizontalCategories(AppLocalizations l10n) {
    final List<Map<String, dynamic>> categories = [
      {
        "title": l10n.translate('popular_cafes'),
        "subtitle": l10n.translate('popular_cafes_subtitle'),
        "color": AppColors.primaryLight,
        "titleColor": AppColors.primaryDark,
        "subtitleColor": AppColors.primary,
        "icon": Icons.coffee_rounded,
        "categoryId": 3, // Cafe category
      },
      {
        "title": l10n.translate('popular_restaurants'),
        "subtitle": l10n.translate('popular_restaurants_subtitle'),
        "color": AppColors.orange,
        "titleColor": AppColors.textOnPrimary,
        "subtitleColor": AppColors.orangeLight,
        "icon": Icons.restaurant_rounded,
        "categoryId": 4, // Restaurant category
      },
      {
        "title": l10n.translate('fast_food'),
        "subtitle": l10n.translate('fast_food_subtitle'),
        "color": AppColors.success,
        "titleColor": AppColors.textOnPrimary,
        "subtitleColor": AppColors.successLight,
        "icon": Icons.fastfood_rounded,
        "categoryId": 2, // Fast food category
      },
    ];
          ...
          return GestureDetector(
            onTap: () {
              Navigator.push(
                ...
                // Orqaga qaytganda restoranlarni qayta yuklash
                _loadRestaurants();
              });
            },
            child: Container(
